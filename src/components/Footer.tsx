          ...
          >
            ...
            <div>
              ...
              <p className="text-[14px] text-white/40 leading-[1.8] font-light max-w-[400px]">
                Frametoque AI Studio is a growing collection of AI tools designed
                around real filmmaking workflows. No fluff, no generic outputs —
                every tool is built around how cinematographers actually think.
              </p>
            </div>

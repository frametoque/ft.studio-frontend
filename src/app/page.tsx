    ...
    <div className="min-h-screen bg-[#060B18] overflow-x-hidden relative">
      ...
      <section className="relative z-[2] max-w-[1400px] mx-auto px-12 grid grid-cols-1 lg:grid-cols-2 min-h-[calc(100vh-64px)] items-center gap-0 lg:px-8 md:px-4">
        ...
        <div className="py-20 lg:pr-16 lg:sticky lg:top-16 fade-1">
          ...
          <p className="text-[15px] md:text-[14px] text-white/40 max-w-[400px] leading-[1.8] font-light mb-10 fade-4">
          ...
          <div className="flex gap-10 sm:gap-6 fade-6">
            {stats.map((s) => (
              <div key={s.label}>
                ...
                <div className="text-[10px] text-white/28 tracking-[0.18em] uppercase mt-1">
                  {s.label}
                </div>
              </div>
            ))}
          ...
          {tools.map((tool, i) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="font-display text-[22px] tracking-[0.05em] text-white mb-1">
                  {tool.name}
                </h4>
                <p
                ...
                <p className="text-[12px] text-white/35 leading-[1.65] mb-3.5 font-light">
                  {tool.description}
                </p>
                ...
                {isLive ? (
                  ...
                  <div className="font-mono text-[10px] text-white/18 tracking-[0.12em]">
                    IN DEVELOPMENT
                  </div>
                )}
              </div>
